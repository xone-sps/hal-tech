...
<head>
    ...
    <link href="{{ url('/') }}/static/css/app.921888125290f38a4bd87bcd94539cd8.css" rel=stylesheet>
</head>
<body>
<div id="app"></div>
<script type=text/javascript src="{{ url('/') }}/manifest.2ae2e69a05c33dfc65f8.js"></script>
